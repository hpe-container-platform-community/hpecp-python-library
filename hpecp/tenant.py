...
class Tenant():
    ...
    def __repr__(self):
        return "<Tenant id:{} name:{} description:{}>".format( self.id, self.name, self.description, self.tenant_type)
...
class TenantController:
    ...
    def list(self):
        response = self.client._request(url='/api/v1/tenant', http_method='get', description='tenant/list')
